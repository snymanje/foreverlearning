...
const projects: React.FC<Props> = () => {
  ...
  return (
    <div>
      ...
      <div className="grid h-full grid-cols-1 grid-rows-1 pt-12 my-auto lg:grid-cols-2">
        <div className="flex flex-col items-center mx-4 text-gray-700">
          <h2 className="text-2xl font-bold">Add Project</h2>
          <div className="flex flex-col flex-wrap items-center justify-center w-full mx-4 mt-6">
            <form onSubmit={(e) => addProjectHandler(e)} className="flex flex-col w-full md:w-96">
        ...
        <div className="flex flex-col items-center justify-start text-gray-700">
          ...
          <div className="flex flex-col flex-wrap mx-4 mt-6">
            {error && <p className="p-3 mb-4 text-center text-red-500 border border-red-500 border-solid">{error}</p>}
